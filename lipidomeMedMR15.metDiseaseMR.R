...
exposureFile="met.exposure.F.csv"        #暴露数据文件
outcomeFile="outcome.csv"                #结局数据文件
beta1SNPfile="beta1.GCST90277248_GCST90199841.table.SNP.csv"      #脂质体到代谢物的SNP文件(beta1)
exposureID="GCST90199841"                #代谢物的ID
outcomeName="Coronary heart disease"     #设置图形中展示疾病的名字
setwd("C:\\Users\\lexb\\Desktop\\lipidomeMedMR\\15.metDiseaseMR")     #设置工作目录
